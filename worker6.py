...
for i in range(THIS_COUNT):
    ...
    port = str(5000 + i + 2)
    t = ExecutionThread(PYTHON_PATH+" launch.py type slave host "+THIS_HOST+" conf "+conf+" port "+port+" masterhost "+MASTER_HOST+" masterport 7001", i)
    t.start()
